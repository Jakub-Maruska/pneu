...
appCheck.activate(
  new firebase.appCheck.ReCaptchaV3Provider(process.env.VITE_RECAPTCHA_SITE_KEY),
...
const DatabaseService = {
  ...
  async getAuthPassword() {
    try {
      ...
      console.error("CRITICAL: Password not configured in Firestore at 'settings/auth'. Login will be disabled until it is set.");
      return null;
    } catch (error) {
